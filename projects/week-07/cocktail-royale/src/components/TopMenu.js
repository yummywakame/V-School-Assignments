    ...
    render() {
        ...
        return (
            <div role="navigation" className="tabs">
                ...
                <li className="tab"><Link className="pink-text" to="/cocktail/roulette" onClick={() => getRandomCocktailDetails()}><span className="material-symbols-outlined">toys_fan</span></Link></li>
                <li className="tab"><Link className="pink-text" to="#!" onClick={this.props.toggleTheme}><i className="material-icons">format_paint</i></Link></li>
            </div>
        )
    }
}
