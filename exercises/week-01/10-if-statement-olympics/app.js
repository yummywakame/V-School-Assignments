...
if (person.age >= 18) {
    console.log("1: " + person.name + " is 18 or over and allowed to go to an R-Rated movie.")
} else {
    console.log("1: " + person.name + " is NOT 18 or over, so is not allowed to go to an R-Rated movie.")
}

// 2. Using that same object, only allow them into the movie if their name starts with "B"
if (person.name.charAt(0) === "B") {
    console.log("2: " + person.name + "'s name starts with 'B' so they are allowed into movie.")
} else {
    console.log("2: " + person.name + "'s name does NOT start with 'B' so they are not allowed into movie.")
}
...
if (person.name.charAt(0) === "B" && person.age >= 18) {
    console.log("3: " + person.name + "'s name starts with 'B' and they are 18 or over, so they are allowed into the movie.")
} else {
    console.log("3: " + person.name + "'s name either does NOT start with 'B' and or they are under the age of 18, so they are not allowed into the movie.")
}
...
if (typeof true) {
    console.log("2: 'true' is not a boolean")
} else {
    console.log("2: 'true' is a boolean")
}
...
if (myVar) {
    console.log("3: myVar is defined")
} else {
    console.log("3: myVar is undefined")
}
...
if ("s" > 12) {
    ...
    console.log("4: 's' is not greater than 12")
}
...
if(myNum % 2) {
    console.log("5: myNum is odd.")
} else {
    console.log("5: myNum is even.")
}